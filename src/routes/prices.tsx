...
export const Route = createFileRoute("/prices")({
  head: () => ({
    meta: [
      { title: "Committee price board — Special Zone 6" },
      {
        name: "description",
        content: "Monthly reference prices for Pa-O crops, set by the cooperative committee.",
      },
      { property: "og:title", content: "Special Zone 6 — Reference Prices" },
      {
        property: "og:description",
        content: "Monthly committee-set reference prices for crops in the Pa-O Self-Administered Zone.",
      },
    ],
  }),
